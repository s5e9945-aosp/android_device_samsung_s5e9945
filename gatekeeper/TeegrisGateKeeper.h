...
class TeegrisGateKeeper {
  public:
    TeegrisGateKeeper() {
        ...
        message.buffer = &shmem_sz_cmd.ptr;
        message.enrolled_password_handle = &shmem_sz_pwd_handle.ptr;
        message.provided_password = &shmem_sz_pwd.ptr;
    ...
    void Verify(const VerifyRequest& request, VerifyResponse* response) {
        ...
        memcpy(shmem_sz_pwd_handle.ptr, request.password_handle.Data<uint8_t>(),
               message.enrolled_password_handle_length);
        memcpy(shmem_sz_pwd.ptr, request.provided_password.Data<uint8_t>(),
               message.provided_password_length);
